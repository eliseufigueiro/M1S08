...
public class BatalhaFinal {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Olá nobre Jogador(a), escolha um nome bacana para o(a) personagem!");
        String nome = sc.nextLine();

        System.out.println("Agora vamos escolher o sexo 'M' ou 'F' (Use Letra Maiúsccula).");
        String sexo = sc.next();

        System.out.println(planilha.classesDisponiveis());
        System.out.println("Que tal as Classes disponíveis? Escolha a sua preferida!");
        Personagem classe = sc.next();

        System.out.println(planilha.armasDisponiveis(classe));
        System.out.println("Agora falta pouco! Escolha sua arma e vamos para a Aventura!");
        Arma arma = Arma.valueOf(sc.next());

        Planilha planilhaFinalizada = new Planilha(nome, sexo, classe, arma);
